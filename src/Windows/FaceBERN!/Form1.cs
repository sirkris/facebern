...
namespace FaceBERN_
{
    public partial class Form1 : Form
    {
        ...
        public void SetStateDefaults()
        {
            ...
            states.Add("CA", new States("", "California", "2016-06-07", "Primary", "Semi-Closed", "108131585873862"));
            states.Add("CO", new States("", "Colorado", "2016-03-01", "Caucus", "Closed", "106153826081984"));
            states.Add("CT", new States("", "Connecticut", "2016-04-26", "Primary", "Closed", "112750485405808"));
            states.Add("DE", new States("", "Delaware", "2016-04-26", "Primary", "Closed", "105643859470062"));
            ...
            states.Add("IN", new States("", "Indiana", "2016-05-03", "Primary", "Open", "111957282154793"));
            states.Add("KS", new States("", "Kansas", "2016-03-05", "Caucus", "Closed", "105493439483468"));
            states.Add("KY", new States("", "Kentucky", "2016-05-17", "Primary", "Closed", "109438335740656"));
            ...
            states.Add("MD", new States("", "Maryland", "2016-04-26", "Primary", "Closed", "108178019209812"));
            ...
            states.Add("NJ", new States("", "New Jersey", "2016-06-07", "Primary", "Semi-Closed", "108325505857259"));
            ...
            states.Add("NY", new States("", "New York", "2016-04-19", "Primary", "Closed", "112825018731802"));
            ...
            states.Add("OR", new States("", "Oregon", "2016-05-17", "Primary", "Closed", "109564342404151"));
            states.Add("PA", new States("", "Pennsylvania", "2016-04-26", "Primary", "Closed", "105528489480786"));
            states.Add("RI", new States("", "Rhode Island", "2016-04-26", "Primary", "Semi-Closed", "108295552526163"));
            ...
            states.Add("WV", new States("", "West Virginia", "2016-05-10", "Primary", "Semi-Closed", "112083625475436"));
            ...
            states.Add("GU", new States("", "Guam", "2016-05-07", "Caucus", "Closed", "112565748760314"));
            states.Add("MP", new States("", "Northern Mariana Islands", "2016-03-12", "Caucus", "Closed", "105540149479841"));
            states.Add("PR", new States("", "Puerto Rico", "2016-06-05", "Caucus", "Open", "108461009175078"));
